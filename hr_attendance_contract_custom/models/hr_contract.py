...
class HrContract(models.Model):
    ...
    allowances = fields.Monetary(
        ...
        tracking=True,
        default=0.0,
        help="Employee's monthly allowances. Defaults to 0 for legacy contracts.",
    )
    ...
    def init(self):
        super().init()
        # Ensure legacy contracts have a numeric allowance to avoid null constraint problems and arithmetic errors.
        self.env.cr.execute("""
            UPDATE hr_contract
               SET allowances = 0
