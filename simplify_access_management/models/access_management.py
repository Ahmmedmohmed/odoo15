...
# تم الاستغناء عن استدعاء request لأنه غير آمن هنا
...
class access_management(models.Model):
    ...
    hide_add_property = fields.Boolean()  # ملاحظة: الـ Properties تم إضافتها في أودو 16، وجود الحقل هنا لن يضر في 15
    ...
    def create(self, vals_list):
        ...
        # التعديل لنسخة 15: استخدام الطريقة الآمنة لمسح الكاش
        self.clear_caches()
        for record in res:
            if record.readonly:
