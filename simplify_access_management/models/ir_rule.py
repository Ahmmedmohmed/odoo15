...
class ir_rule(models.Model):
    ...
    # -------------------------------------------------------------------------
    # التعديل لـ Odoo 15: إزالة tools.conditional واستخدام ormcache المباشر
    # -------------------------------------------------------------------------
    @api.model
    ...
    def _compute_domain(self, model_name, mode="read"):
        ...
        # ملاحظة: mail.channel هو الاسم الصحيح في أودو 15 (في 17 تم تغييره لـ discuss.channel لكن المطور نسى يغيره في الكود الأصلي، فده في مصلحتنا!)
